...
где type (RequestsAgreeDocs - Файлы для заявки на согласование, visits - Файлы для документа Посещение торговых точек) тип данных для которых передаются файлы, guid - идентификатор объекта данных
