...
В версии 1.1.16.1 добавлены новые сервисы [Список работ по заданиям МП пользователя](#список-работ-по-заданиям-мп-пользователя), [Работы по заданиям](#работы-по-заданиям).

В версии 1.1.16.3 сервисы типы заданий изменен на [Типы заданий пользователя](#типы-заданий-пользователя)

В версии 1.1.16.4 добавлены новые сервисы [Накладные пользователя](#накладные-пользователя), [Поступление денежных средств](#поступление-денежных-средств).

В версии 1.1.16.5 В сервисы [Заявки МП для согласования](#заявки-мп-для-согласования) и [Получить данные заявок на согласование](#получить-данные-заявок-на-согласование) добавлено свойство taskUid

В версии 1.1.16.6 В сервисы [Работы по заданиям](#работы-по-заданиям) и [Список работ по заданиям МП пользователя](#список-работ-по-заданиям-мп-пользователя) добавлено свойство taskUid вместо taskNumber
...
```html
https://server.ru/api/v1/taskTypes/forUser/?userId={userId}
```
...
```html
https://server.ru/api/v1/taskTypes/forUser?userId=000001
```
...
## Накладные пользователя

### Описание

Предназначен для накладных пользователя из 1С
...
```html
https://server.ru/api/v1/Invoices/forUser/?userId={userId}
```
...
| Параметры                                |     Тип      | Обязательный | Описание                          |
| ---------------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-накладные-пользователя) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                                    | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                                | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                                   | Null, Строка |      Да      | Текст с дополнительной информации |

#### **result (Накладные пользователя):**

| Параметры       |             Тип             | Обязательный | Описание                             |
| --------------- | :-------------------------: | :----------: | :----------------------------------- |
| uID             |         Строка (36)         |      Да      | Идентификатор накладной              |
| number          |         Строка (11)         |      Да      | Номер накладной                      |
| date            | Дата (строка в формате UTC) |      Да      | Дата накладной                       |
| deliveryDate    | Дата (строка в формате UTC) |      Да      | Дата доставки                        |
| tradeshopUid    |         Строка (11)         |      Да      | Код торговой точки                   |
| contractUid     |         Строка (36)         |      Да      | Идентификатор соглашения             |
| storageUid      |         Строка (11)         |      Да      | Код склада                           |
| plTypeUid       |         Строка (36)         |      Да      | Идентификатор типа цены              |
| taskUid         |         Строка (36)         |      Да      | Идентификатор МП задания на доставку |
| quantity        |        Число (15, 3)        |      Да      | Общее количество из таблицы товаров  |
| amount          |        Число (15, 2)        |      Да      | Сумма документа                      |
| debt            |        Число (15, 2)        |      Да      | Сумма задолженности                  |
| mobileState     |          Число (1)          |      Да      | Всегда 3                             |
| deliveryState   |          Число (1)          |      Да      | Всегда 1                             |
| deliveryComment |        Строка (500)         |      Да      | Комментарий по доставке              |
...
```html
https://server.ru/api/v1/Invoices/forUser?userId=000001
```
...
```json
{
  "result": [
    {
      "uID": "7769ad33-fb73-11ec-80c6-3640b588c99b",
      "number": "ENUT-026036",
      "date": "04.07.2022",
      "deliveryDate": "04.07.2022",
      "tradeshopUid": "00-00003282",
      "contractUid": "22559f6c-a13d-11ec-b0c0-00a15c010a2c",
      "storageUid": "Н0018",
      "plTypeUid": "6658d303-93dc-11ec-80c5-3640b588c99b",
      "taskUid": "",
      "quantity": 278,
      "amount": 2451.26,
      "debt": 2451.26,
    ...
    {
      "uID": "7769ad36-fb73-11ec-80c6-3640b588c99b",
      "number": "ENUT-026037",
      "date": "04.07.2022",
      "deliveryDate": "04.07.2022",
      "tradeshopUid": "00-00003285",
      "contractUid": "22559f6c-a13d-11ec-b0c0-00a15c010a2c",
      "storageUid": "Н0018",
      "plTypeUid": "6658d303-93dc-11ec-80c5-3640b588c99b",
      "taskUid": "",
...
| Параметры                        |     Тип      | Обязательный | Описание                          |
| -------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-sales-channels) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                            | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                        | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                           | Null, Строка |      Да      | Текст с дополнительной информации |
...
| Параметры                          |     Тип      | Обязательный | Описание                          |
| ---------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-equipment-models) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                              | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                          | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                             | Null, Строка |      Да      | Текст с дополнительной информации |

#### **result (Equipment models):**
...
| Параметры                 |     Тип      | Обязательный | Описание                          |
| ------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-regions) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                     | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                 | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                    | Null, Строка |      Да      | Текст с дополнительной информации |
...
| Параметры                         |     Тип      | Обязательный | Описание                          |
| --------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-types-of-prices) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                             | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                         | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                            | Null, Строка |      Да      | Текст с дополнительной информации |

#### **result (Types of prices):**
...
| Параметры                           |     Тип      | Обязательный | Описание                          |
| ----------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-list-of-customers) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                               | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                           | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                              | Null, Строка |      Да      | Текст с дополнительной информации |
...
| Параметры                                       |     Тип      | Обязательный | Описание                          |
| ----------------------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-list-of-customers-TIN-and-KPP) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                                           | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                                       | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                                          | Null, Строка |      Да      | Текст с дополнительной информации |

#### **result (List of customers TIN and KPP):**
...
| Параметры                                 |     Тип      | Обязательный | Описание                          |
| ----------------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-list-of-customer-orders) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                                     | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                                 | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                                    | Null, Строка |      Да      | Текст с дополнительной информации |
...
| mobileState                                 |    Число    |      Да      | Всегда 3                                   |
| [details](#details-list-of-customer-orders) |   Массив    |      Да      | Данные товаров                             |

#### **details (List of customer orders):**
...
| Параметры                   |     Тип      | Обязательный | Описание                          |
| --------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-schedules) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                       | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                   | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                      | Null, Строка |      Да      | Текст с дополнительной информации |
...
| Параметры                            |     Тип      | Обязательный | Описание                          |
| ------------------------------------ | :----------: | :----------: | :-------------------------------- |
| [result](#result-works-by-task-type) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                                | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                            | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                               | Null, Строка |      Да      | Текст с дополнительной информации |

#### **result (Works by task type):**
...
| Параметры                                        |     Тип      | Обязательный | Описание                          |
| ------------------------------------------------ | :----------: | :----------: | :-------------------------------- |
| [result](#result-equipment-maintenance-statuses) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                                            | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                                        | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                                           | Null, Строка |      Да      | Текст с дополнительной информации |

#### **result (Equipment maintenance statuses):**
...
| Параметры                                      |     Тип      | Обязательный | Описание                          |
| ---------------------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-equipment-operation-statuses) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                                          | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                                      | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                                         | Null, Строка |      Да      | Текст с дополнительной информации |

#### **result (Equipment operation statuses):**
...
Предназначен для получения оборудования по складу
...
```html
https://server.ru/api/v1/storages/machines/?storageId={storageId}
```

где storageId код склада

Тело ответа содержит _JSON_ с следующими параметрами:

| Параметры                                 |     Тип      | Обязательный | Описание                          |
| ----------------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-equipment-in-warehouses) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                                     | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                                 | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                                    | Null, Строка |      Да      | Текст с дополнительной информации |

#### **result (Equipment in warehouses):**
...
```html
https://server.ru/api/v1/storages/machines?storageId=10369
```
...
Предназначен для получения последнего задания по оборудованию
...
```html
https://server.ru/api/v1/machines/tasks/last?uid={uid}
```

где uid код оборудования

Тело ответа содержит _JSON_ с следующими параметрами:

| Параметры                             |     Тип      | Обязательный | Описание                          |
| ------------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-last-equipment-task) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                                 | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                             | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                                | Null, Строка |      Да      | Текст с дополнительной информации |

#### **result (Last equipment task):**

| Параметры        |             Тип             | Обязательный | Описание                                        |
| ---------------- | :-------------------------: | :----------: | :---------------------------------------------- |
| uID              |           Строка            |      Да      | Идентификатор задачи в МП                       |
| taskNumber       |         Строка (9)          |      Да      | Код задания МП                                  |
| machineUid       |         Строка (6)          |      Да      | Код оборудования                                |
| tradeshopUid     |         Строка (11)         |      Да      | Код торговой точки                              |
| taskTypeId       |          Число (3)          |      Да      | Код типа задания                                |
| datePlanned      | Дата (строка в формате UTC) |      Да      | Дата задания                                    |
...
| dateDeleted      | Дата (строка в формате UTC) |      Да      | Дата удаления                                   |
| mobileState      |            Число            |      Да      | На данный момент не используется                |
| dateStart        | Дата (строка в формате UTC) |      Да      | Начало выполнения (из посещения)                |
| dateEnd          | Дата (строка в формате UTC) |      Да      | Окончание выполнения (из посещения)             |
| utcDateTimeStart | Дата (строка в формате UTC) |      Да      | На данный момент не используется                |
| utcDateTimeEnd   | Дата (строка в формате UTC) |      Да      | На данный момент не используется                |
| latitudeStart    |         Строка (20)         |      Да      | Широта начало (из посещения)                    |
| longitudeStart   |         Строка (20)         |      Да      | Долгота начало (из посещения)                   |
| latitudeEnd      |         Строка (20)         |      Да      | Широта окончание (из посещения)                 |
| longitudeEnd     |         Строка (20)         |      Да      | Долгота окончание (из посещения)                |
| visitUid         |           Строка            |      Да      | Идентификатор в МП (Посещение торговых точек)   |
...
```html
https://server.ru/api/v1/machines/tasks/last?uid=002788
```
...
```json
{
  "result": [
    {
      "uID": "a7c2af57-fe9f-4086-90e5-8248385efdaa",
      "taskNumber": "000000130",
      "machineUid": "002788",
      "tradeshopUid": "00-00001543",
      "taskTypeId": 1,
      "datePlanned": "2023-10-13",
      "dateCreate": "2023-10-13T14:49:01+03:00",
      "dateChanged": "2023-11-05T18:17:30+03:00",
      "workerUserUid": "",
      "state": 2,
      "comment": "",
      "authorUserUid": "87feb25b-5c04-11ec-80c5-3640b588c99b",
      "priority": 0,
      "active": 1,
      "parentTaskUid": "",
      "dateDeleted": "0001-01-01T00:00:00+00:00",
      "mobileState": 1,
      "dateStart": "2023-10-13T11:47:54+03:00",
      "dateEnd": "2023-10-13T11:48:10+03:00",
      "utcDateTimeStart": "0001-01-01T00:00:00+00:00",
      "utcDateTimeEnd": "0001-01-01T00:00:00+00:00",
      "latitudeStart": "55.7544117",
      "longitudeStart": "37.6183883",
      "latitudeEnd": "55.75441166666667",
      "longitudeEnd": "37.618388333333336",
      "visitUid": "A314ED83-2AED-4653-8546-404279659F39"
    }
  ],
  "error": null,
  "errorCode": null,
