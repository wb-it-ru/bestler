...
| visitUid                                          |           Строка            |      Да      | Идентификатор в МП (Посещение торговых точек)   |
| [taskOperations](#taskoperations-task-operations) |           Массив            |      Да      | Список работ по заданию                         |
...
```html
https://server.ru/api/v1/machines/tasks/last?uid=006498
```
  ...
  "result": [
    {
      ...
      "taskNumber": "000000011",
      "machineUid": "006498",
      "tradeshopUid": "00-00004082",
      "storageUid": "",
      "taskTypeId": 1,
      "datePlanned": "0001-01-01",
      "dateCreate": "2023-10-09T00:15:11",
      "dateChanged": "0001-01-01T00:00:00",
      "workerUserUid": "",
      "state": 2,
      "comment": "",
      "authorUserUid": "11f964e9-b8ca-11ec-b1c3-00a15c010a2c",
      "priority": 0,
      "active": 1,
      "parentTaskUid": "",
      "dateDeleted": "0001-01-01T00:00:00",
      ...
      "dateStart": "0001-01-01T00:00:00",
      "dateEnd": "0001-01-01T00:00:00",
      "utcDateTimeStart": "0001-01-01T00:00:00",
      "utcDateTimeEnd": "0001-01-01T00:00:00",
      "latitudeStart": "",
      "longitudeStart": "",
      "latitudeEnd": "",
      "longitudeEnd": "",
      ...
      "taskOperations": [
        {
          "uID": "a496d1a9-4702-424d-8c3f-d240cf6bc815",
          "taskUid": "a7c2af57-fe9f-4086-90e5-8248385efdaa",
          "operationTypeId": "00027",
          "position": 1,
          "description": "монтаж",
          "state": 0,
          "comment": "монтаж",
        ...
        {
          "uID": "9c11b91a-dbc4-4ea6-86fc-62223910b39b",
          "taskUid": "a7c2af57-fe9f-4086-90e5-8248385efdaa",
          "operationTypeId": "00029",
          "position": 2,
          "description": "обслуживание",
          "state": 1,
          "comment": "обслуживание",
          "performedOperationUid": "NULL",
          "active": 1
        }
      ]
...
Предназначен для получения списка статусов доставки с причинами
...
```html
https://server.ru/api/v1/deliveryStates
```
...
| Параметры                             |     Тип      | Обязательный | Описание                          |
| ------------------------------------- | :----------: | :----------: | :-------------------------------- |
| [result](#result-get-delivery-status) | Null, Массив |      Да      | Не заполняется при ошибке         |
| error                                 | Null, Строка |      Да      | Строка описания ошибки            |
| errorCode                             | Null, Строка |      Да      | Код ошибки в классификации API    |
| notice                                | Null, Строка |      Да      | Текст с дополнительной информации |

#### **result (Get delivery status):**

| Параметры |     Тип      | Обязательный | Описание                                 |
| --------- | :----------: | :----------: | :--------------------------------------- |
| stateID   |  Число (3)   |      Да      | Код статуса доставки                     |
| state     | Строка (50)  |      Да      | Наименование статуса доставки            |
| reasonID  |  Число (3)   |      Да      | Код причины (-1 если причина не указана) |
| reason    | Строка (100) |      Да      | Наименование причины                     |
...
```json
{
  "result": [
    ...
    },
    {
      ...
      "state": "Статус 2",
      "reasonID": 4,
      "reason": "КК: блокировка"
    },
    {
      "stateID": 2,
      "state": "Статус 2",
      "reasonID": 5,
      "reason": "КК: недостаточный кредитный лимит"
    },
    {
      "stateID": 3,
      "state": "Статус 3",
